...
class UUIDUtils {
    ...
    static async fromUUIDs(uuids: ActorUUID[], options?: { relative?: Maybe<ClientDocument> }): Promise<ActorAvant[]>;
    static async fromUUIDs(uuids: ItemUUID[], options?: { relative?: Maybe<ClientDocument> }): Promise<ItemAvant[]>;
