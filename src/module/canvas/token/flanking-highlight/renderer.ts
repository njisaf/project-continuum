...
class FlankingHighlightRenderer {
    ...
    constructor(token: TokenAvant) {
        this.token = token;
        this.labelText = game.i18n.localize("AVANT.Token.Flanking");
     ...
     */
    drawForTarget(target: TokenAvant): void {
     ...
     */
    drawBuddyLines(buddies: TokenAvant[]): void {
     ...
     */
    drawBuddyLine(buddy: TokenAvant): void {
     ...
     * @param buddy Flanking buddy token
     */
    drawLabel(buddy: TokenAvant): void {
