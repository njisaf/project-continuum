...
import type { BaseItemSourceAvant, ItemSystemData, ItemSystemSource, ItemTraits } from "@item/base/data/system.ts";
...
type SpellSource = BaseItemSourceAvant<"spell", SpellSystemSource>;
