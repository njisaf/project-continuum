...
const PERSISTENT_DAMAGE_IMAGES: Partial<Record<DamageType, ImageFilePath>> = {
    ...
    bludgeoning: "systems/avant/icons/equipment/weapons/bola.webp",
    cold: "icons/magic/water/ice-snowman.webp",
    electricity: "systems/avant/icons/spells/chain-lightning.webp",
    fire: "icons/magic/fire/flame-burning-creature-skeleton.webp",
    force: "systems/avant/icons/spells/magic-missile.webp",
    mental: "systems/avant/icons/spells/modify-memory.webp",
    piercing: "systems/avant/icons/equipment/weapons/throwing-knife.webp",
    poison: "systems/avant/icons/spells/acidic-burst.webp",
    slashing: "systems/avant/icons/equipment/weapons/scimitar.webp",
    sonic: "systems/avant/icons/spells/cry-of-destruction.webp",
    spirit: "icons/magic/unholy/hand-claw-fire-blue.webp",
    vitality: "systems/avant/icons/spells/moment-of-renewal.webp",
    void: "systems/avant/icons/spells/grim-tendrils.webp",
};
