...
interface BaseRollContext {
    ...
    notes?: (RollNoteAvant | RollNoteSource)[];
...
export type { AttackRollParams, BaseRollContext, DamageRollParams, RollDataAvant, RollParameters, RollTwiceOption };
