...
class RollNoteRuleElement extends RuleElementAvant<RollNoteSchema> {
...
interface RollNoteRuleElement extends RuleElementAvant<RollNoteSchema>, ModelPropsFromRESchema<RollNoteSchema> {}
