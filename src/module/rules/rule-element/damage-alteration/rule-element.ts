...
import { ResolvableValueField, RuleElementAvant } from "../index.ts";
...
class DamageAlterationRuleElement extends RuleElementAvant<DamageAlterationSchema> {
...
interface DamageAlterationRuleElement
    extends RuleElementAvant<DamageAlterationSchema>,
