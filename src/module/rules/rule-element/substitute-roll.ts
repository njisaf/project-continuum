...
class SubstituteRollRuleElement extends RuleElementAvant<SubstituteRollSchema> {
    ...
    override async afterRoll(params: RuleElementAvant.AfterRollParams): Promise<void> {
...
interface SubstituteRollRuleElement
    extends RuleElementAvant<SubstituteRollSchema>,
