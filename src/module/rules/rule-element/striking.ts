...
class StrikingRuleElement extends RuleElementAvant<StrikingRuleSchema> {
...
interface StrikingRuleElement extends RuleElementAvant<StrikingRuleSchema>, ModelPropsFromRESchema<StrikingRuleSchema> {}
