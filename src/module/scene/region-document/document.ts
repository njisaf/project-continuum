import type { RegionAvant } from "@module/canvas/region.ts";
import type { SceneAvant } from "@scene";
import type { SpecificRegionBehavior } from "@scene/region-behavior/types.ts";

class RegionDocumentAvant<TParent extends SceneAvant | null = SceneAvant | null> extends RegionDocument<TParent> {
...
interface RegionDocumentAvant<TParent extends SceneAvant | null = SceneAvant | null> extends RegionDocument<TParent> {
    readonly behaviors: foundry.abstract.EmbeddedCollection<SpecificRegionBehavior<this>>;

    _object: RegionAvant<this>;
}

export { RegionDocumentAvant };
